<div class="container-fluid">
    ...
    <div class="alert alert-success" role="alert">
        <i class="fas fa-book-open"></i> Form Input Jurusan
    </div>

    <form method="post" action="<?php echo base_url('admin/jurusan2/input_aksi') ?>">
        <div class="form-group">
            <label>Kode Jurusan</label>
            <input type="text" name="kode_jurusan" placeholder="Masukkan Kode Jurusan" class="form-control " autofocus>
