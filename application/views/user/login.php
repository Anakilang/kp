...
<head>
    ...
    <link href="bootstrap4/css/sb-admin-2.min.css" rel="stylesheet">
...
<body class="bg-gradient-primary">
                                ...
                                <div class="p-5">
                                    ...
                                    <form method="post" action="<?php echo base_url('admin/auth/proses_login') ?>" class="user">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_error('user', '<div class="text-danger small ml-3">', '</div>') ?>
                                        </div>
                                        <div class="form-group">
    ...
    <script src="bootstrap4/img/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="bootstrap4/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="bootstrap4/js/sb-admin-2.min.js"></script>
